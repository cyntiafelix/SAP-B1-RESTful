...
from .sapb1api import InfoAPI, CodeAPI, OrdersAPI, QuotesAPI, ContactsAPI, ShipmentsAPI, ItemsAPI, PricesAPI, CustomersAPI, StockAPI
...
api_v1.add_resource(StockAPI, '/stock')
